#!/usr/bin/env python3
"""
Simplified update_services.py for DeepSeek using unitysvc_services data builders.
...
class ModelExtractor:
    ...
    def build_listing(self, model_id: str) -> ListingDataBuilder:
        ...
        builder.set_raw("service_options", {"default_parameters": {"api_key": "${ secrets.DEEPSEEK_API_KEY }"}})
